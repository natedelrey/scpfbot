...
# Legacy/alternate Level-3 role ID still present in some servers.
ALT_LEVEL_3_ROLE_ID = 1233139781840670742
...
SSU_ALLOWED_ROLES = [str(LEVEL_3_ROLE_ID), str(ALT_LEVEL_3_ROLE_ID), *EP_AND_ABOVE_ROLES]
DD_AND_ABOVE_ROLES = [
    "1246963191699734569", "1233139781840670742", "1233139781840670743",
    "1233139781840670746"
]
NOTIFY_AND_APP_ROLES = EP_AND_ABOVE_ROLES + ["1234517225206059019", "1508079170192932986"]
...
DISCORD_RANK_LIMITS = {
    ...
    "1508079170192932986": 7,    # Added role -> max Level-3 Roblox (value 5)
}
...
async def auto_class_d_ranker():
    auto_class_d_debug(f"Auto Class-D ranker tick started using flow {get_auto_class_d_flow_version()}.")
    try:
